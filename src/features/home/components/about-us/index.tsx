          ...
          <Container className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <Container className="mt-10 lg:mt-0">
              ...
              >
                ...
                travel experts are here to craft unforgettable experiences that
                leave a lasting impression. Join us as we share our love for
                travel and create memories that last a lifetime.
              </Text>
            </Container>
          </Container>
        </Container>
