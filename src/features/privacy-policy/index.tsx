    ...
    <BackGroundDiv>
      <Container className="w-full relative mx-auto px-4 sm:px-8 py-3 h-[calc(100vh-198px)] overflow-y-scroll">
        <div className="flex align-items-end justify-between">
          <h3 className="text-center font-bold text-xl">Privacy policy</h3>
          <span className="text-sm text-gray-400">
            Last updated on 04-04-2024 16:32:17
          </span>
        </div>
        <div className="w-auto my-4">
          <p className="text-justify my-2">
            This privacy policy (“Policy”) relates to the manner BAHA TRAVELS
            PRIVATE LIMITED (“we”, “us”, “our”) in which we use, handle and
          ...
          <p className="text-justify my-2">
            BAHA TRAVELS PRIVATE LIMITED may change this Policy periodically and
            we urge you to check this page for the latest version of the Policy
            in order to keep yourself updated.
          </p>
          ...
          <p className="text-justify my-2">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                your requests, respond to your queries, fulfil your orders or
                for other operational and business reasons.
              </li>
          ...
          <h2 className="font-bold text-2xl my-4">How we use cookies</h2>
          <p className="text-justify my-2">
          ...
          <p className="text-justify my-2">
            ...
            writing to our email ID: amit@baha.co.inIn the event you choose to
          ...
          <h2 className="font-bold text-2xl my-4">Data Security</h2>
          <p className="text-justify my-2">
